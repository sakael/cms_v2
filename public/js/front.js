...
$(document).ready(function () {
  ...
  if (Cookies.get("theme_csspath")) {
    $("link#theme-stylesheet").attr("href", Cookies.get("theme_csspath"));
  }
  ...
  $("#colour").change(function () {
    if ($(this).val() !== "") {
      ...
      Cookies.set("theme_csspath", theme_csspath, { expires: 365, path: document.URL.substr(0, document.URL.lastIndexOf("/")) });
    }
