					...
					<form class="form-horizontal" accept-charset="utf-8">
						<div class="tab-content">
							...
							<div
								...
								<div class="form-group row mb-3">
										<label class="col-2 col-form-label" for="description">Beschrijving</label>
										<div class="col-10">
								...
								<div class="form-group row mb-3">
										<label class="col-2 col-form-label" for="title_external">Titel extern</label>
										<div class="col-10">
								...
								<div class="form-group row mb-3">
										<label class="col-2 col-form-label" for="description_external">Beschrijving extern</label>
										<div class="col-10">
								...
								<div class="form-group row mb-3">
										<label class="col-2 col-form-label"for="seo_title">Seo Titel</label>
										<div class="col-10">
								...
								<div class="form-group row mb-3"k>
										<label class="col-2 col-form-label"for="description">Seo Beschrijving</label>
										<div class="col-10">
								...
								<div class="form-group row mb-3">
										<label class="col-2 col-form-label" for="youtube_code">Youtube code</label>
										<div class="col-10">
							...
							<div class="tab-pane fade in" id="main_information_measurements" role="tabpanel">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12">
											<br/><span>
												<small>Alleen nodig bij universele artikelen</small>
											</span>
											<hr>
										</div>
									</div>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<label class="form-control">
													<input type="checkbox" data-mapping="other-info" data-mappingkey="package" name="package" {% if (product.package) %} checked {% endif %} value="1">
													ja, altijd als pakket versturen
												</label>
											</div>
										</div>
										<div class="col-md-3">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<label></label>
												<label class="form-control">
													<input type="checkbox" {% if (product.active) %} checked {% endif %} data-mapping="other-info" data-mappingkey="active" name="active" value="1">
													Active
												</label>
											</div>
										</div>
