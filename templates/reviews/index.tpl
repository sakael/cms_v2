...
{% block content %}
	...
	<ul class="nav nav-pills bg-nav-pills nav-justified">
		<li class="nav-item">
			<a class="nav-link active" data-toggletab="new_tab" data-toggle="tab" href="#new_tab" role="tab">Niewe productreviews</a>
		</li>
		<li class="nav-item">
			<a class="nav-link" data-toggletab="all_reviews_tab" data-toggle="tab" href="#all_reviews_tab" role="tab">Alle productreviews</a>
		</li>
	</ul>
	<!-- Tab panels -->
	<div
...
{% block javascript %}
	...
	<script>
        ...
        mounted: function (){{% for key,categoriesContent in Type.categories_contents %}
