...
{% block content %}
	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box">
				<h4 class="page-title">{{auth.user.name}}
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<form id="register-form" method="post" action="{{path_for('auth.account.post')}}" autocomplete="off" class="form-horizontal bg-white p-3 needs-validation" novalidate>
						...
						<div class="form-group{{ errors.lastname ? ' has-danger': ''}}">
							<label for="lastname" class="label-material">Achternaam</label>
