...
*/
  ...
  gulp
    .src([
      baseAssets + "js/vendor/jquery.min.js",
      baseAssets + "js/vendor/bootstrap.bundle.min.js",
      baseAssets + "js/vendor/moment.js",
      baseAssets + "js/vendor/nl.js",
      baseAssets + "js/vendor/simplebar.min.js",
      baseAssets + "js/vendor/daterangepicker.js",
      baseAssets + "js/vendor/metisMenu.min.js",
